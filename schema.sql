...
-- ─────────────────────────────────────────────────────────────────────────
-- Journal des e-mails envoyés — évite les doublons (une campagne peut être envoyée en
-- plusieurs fois à cause de la limite quotidienne du plan gratuit Resend, et le mail
-- automatique de feedback ne doit partir qu'une fois par joueur). Accès service_role
