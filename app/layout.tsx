  ...
  return (
    <html lang="fr" className="dark">
      <body className="font-sans antialiased">
        <header className="border-b border-line sticky top-0 z-50 bg-bg/90 backdrop-blur">
          <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
            ...
            <button
              ...
              className="text-sm text-ink-muted border border-line rounded px-2.5 py-1 hover:border-line-strong transition-colors font-mono"
            >
              ⌘K
            </button>
          </div>
