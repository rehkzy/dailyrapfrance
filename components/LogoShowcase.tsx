...
// Emblème de marque mis en valeur : verre dépoli, balayage de lumière animé, léger effet 3D
// qui suit le curseur (desktop) ou respire doucement tout seul (mobile, pas de souris).
    ...
    <div className="[perspective:800px]">
      <div
        ...
        style={{
          ...
          boxShadow: "0 30px 80px -20px rgba(240,0,28,0.45), inset 0 1px 0 rgba(255,255,255,0.08)",
        }}
      >
        ...
        <img
          src="/icon.svg"
          alt="DailyRapFrance"
          className="relative w-[58%] h-[58%] object-contain drop-shadow-[0_0_30px_rgba(240,0,28,0.5)]"
        />
      </div>
    </div>
  );
